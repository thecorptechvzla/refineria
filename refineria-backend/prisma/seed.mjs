...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    update: {},
    create: { name: 'César Mendoza', email: 'admin@goldtrack.com', password: hashedPassword, role: 'ADMIN' },
  });

  await prisma.user.upsert({
    where: { email: 'dueno@goldtrack.com' },
    update: {},
    create: { name: 'Alejandro Vargas', email: 'dueno@goldtrack.com', password: hashedPassword, role: 'SUPERADMIN' },
  });
