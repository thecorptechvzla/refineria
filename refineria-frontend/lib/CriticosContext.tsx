...
function buildDefaultState(): CriticosState {
  return {
    quimicos: [
      {
        id: '1', name: 'Acido Clorhidrico (Lts)', unit: 'Lts',
        initialStock: 5949, ajuste: 20013, dailyConsumption: 216, minimum: 860,
        history: [
          { date: '28/05', v: 216 }, { date: '29/05', v: 216 }, { date: '30/05', v: 216 },
          { date: '31/05', v: 216 }, { date: '01/06', v: 216 }, { date: '02/06', v: 216 },
          { date: '03/06', v: 216 }, { date: '04/06', v: 216 }, { date: '05/06', v: 216 },
          { date: '06/06', v: 216 }, { date: '07/06', v: 216 }, { date: '08/06', v: 216 },
          { date: '09/06', v: 216 }, { date: '10/06', v: 216 }, { date: '11/06', v: 216 },
          { date: '12/06', v: 216 }, { date: '13/06', v: 216 }, { date: '14/06', v: 216 },
          { date: '15/06', v: 216 }, { date: '16/06', v: 0 },   { date: '16/06', v: 216 },
          { date: '17/06', v: 216 }, { date: '18/06', v: 216 }, { date: '19/06', v: 216 },
          { date: '20/06', v: 216 }, { date: '21/06', v: 216 },
          { date: '23/06', v: 216 }, { date: '24/06', v: 216 }, { date: '25/06', v: 216 },
          { date: '26/06', v: 54 },  { date: '27/06', v: 0 },
        ],
      },
      {
        id: '2', name: 'Acido Nitrico (Lts)', unit: 'Lts',
        initialStock: 3711, ajuste: 3781, dailyConsumption: 120, minimum: 500,
        history: [
          { date: '28/05', v: 120 }, { date: '29/05', v: 102 }, { date: '30/05', v: 102 },
          { date: '31/05', v: 102 }, { date: '01/06', v: 102 }, { date: '02/06', v: 72 },
          { date: '03/06', v: 72 },  { date: '04/06', v: 72 },  { date: '05/06', v: 72 },
          { date: '06/06', v: 72 },  { date: '07/06', v: 72 },  { date: '08/06', v: 72 },
          { date: '09/06', v: 72 },  { date: '10/06', v: 72 },  { date: '11/06', v: 72 },
          { date: '12/06', v: 72 },  { date: '13/06', v: 72 },  { date: '14/06', v: 72 },
          { date: '15/06', v: 72 },  { date: '16/06', v: 0 },   { date: '16/06', v: 72 },
          { date: '17/06', v: 72 },  { date: '18/06', v: 72 },  { date: '19/06', v: 72 },
          { date: '20/06', v: 72 },  { date: '21/06', v: 72 },
          { date: '23/06', v: 72 },  { date: '24/06', v: 72 },  { date: '25/06', v: 72 },
          { date: '26/06', v: 18 },  { date: '27/06', v: 0 },
        ],
      },
      {
        id: '3', name: 'Metalbisulfito (kg)', unit: 'kg',
        initialStock: 1619, ajuste: 2801, dailyConsumption: 75, minimum: 300,
        history: [
          { date: '28/05', v: 75 },  { date: '29/05', v: 75 },  { date: '30/05', v: 74 },
          { date: '31/05', v: 75 },  { date: '01/06', v: 72 },  { date: '02/06', v: 72 },
          { date: '03/06', v: 72 },  { date: '04/06', v: 72 },  { date: '05/06', v: 72 },
          { date: '06/06', v: 72 },  { date: '07/06', v: 72 },  { date: '08/06', v: 72 },
          { date: '09/06', v: 72 },  { date: '10/06', v: 72 },  { date: '11/06', v: 72 },
          { date: '12/06', v: 72 },  { date: '13/06', v: 72 },  { date: '14/06', v: 72 },
      ...
      {
        id: '4', name: 'Urea (kg)', unit: 'kg',
        initialStock: 5876, ajuste: -124, dailyConsumption: 72, minimum: 600,
        history: [
          { date: '28/05', v: 70 },  { date: '29/05', v: 72 },  { date: '30/05', v: 72 },
          { date: '31/05', v: 72 },  { date: '01/06', v: 72 },  { date: '02/06', v: 72 },
          { date: '03/06', v: 72 },  { date: '04/06', v: 72 },  { date: '05/06', v: 72 },
          { date: '06/06', v: 72 },  { date: '07/06', v: 42 },  { date: '08/06', v: 72 },
          { date: '09/06', v: 72 },  { date: '10/06', v: 72 },  { date: '11/06', v: 72 },
          { date: '12/06', v: 72 },  { date: '13/06', v: 72 },  { date: '14/06', v: 72 },
          { date: '15/06', v: 72 },  { date: '16/06', v: 0 },   { date: '16/06', v: 72 },
          { date: '17/06', v: 72 },  { date: '18/06', v: 72 },  { date: '19/06', v: 72 },
      ...
      {
        id: '5', name: 'Soda Caustica (Lts)', unit: 'Lts',
        initialStock: 350, ajuste: 0, dailyConsumption: 0, minimum: 120,
        history: [
          { date: '28/05', v: 0 }, { date: '29/05', v: 0 }, { date: '30/05', v: 0 },
          { date: '31/05', v: 0 }, { date: '01/06', v: 0 }, { date: '02/06', v: 0 },
          { date: '03/06', v: 0 }, { date: '04/06', v: 0 }, { date: '05/06', v: 0 },
          { date: '06/06', v: 0 }, { date: '07/06', v: 0 }, { date: '08/06', v: 0 },
          { date: '09/06', v: 0 }, { date: '10/06', v: 0 }, { date: '11/06', v: 0 },
          { date: '12/06', v: 0 }, { date: '13/06', v: 0 }, { date: '14/06', v: 0 },
          { date: '15/06', v: 0 }, { date: '16/06', v: 0 }, { date: '16/06', v: 0 },
          { date: '17/06', v: 0 }, { date: '18/06', v: 0 }, { date: '19/06', v: 0 },
          { date: '20/06', v: 0 }, { date: '21/06', v: 0 },
          { date: '23/06', v: 0 }, { date: '24/06', v: 0 }, { date: '25/06', v: 0 },
          { date: '26/06', v: 0 }, { date: '27/06', v: 0 },
        ],
      },
      {
        id: '6', name: 'Soda Caustica (Kg)', unit: 'Kg',
        initialStock: 1800, ajuste: -100, dailyConsumption: 0, minimum: 250,
        history: [
          { date: '28/05', v: 0 }, { date: '29/05', v: 0 }, { date: '30/05', v: 0 },
          { date: '31/05', v: 0 }, { date: '01/06', v: 0 }, { date: '02/06', v: 0 },
          { date: '03/06', v: 0 }, { date: '04/06', v: 0 }, { date: '05/06', v: 0 },
      ...
      {
        id: '7', name: 'Amoniaco (Lts)', unit: 'Lts',
        initialStock: 1834, ajuste: 580, dailyConsumption: 60, minimum: 500,
        history: [
          { date: '28/05', v: 60 }, { date: '29/05', v: 60 }, { date: '30/05', v: 54 },
          { date: '31/05', v: 60 }, { date: '01/06', v: 60 }, { date: '02/06', v: 60 },
          { date: '03/06', v: 60 }, { date: '04/06', v: 60 }, { date: '05/06', v: 60 },
          { date: '06/06', v: 60 }, { date: '07/06', v: 60 }, { date: '08/06', v: 60 },
          { date: '09/06', v: 60 }, { date: '10/06', v: 60 }, { date: '11/06', v: 60 },
          { date: '12/06', v: 60 }, { date: '13/06', v: 60 }, { date: '14/06', v: 60 },
          { date: '15/06', v: 60 }, { date: '16/06', v: 0 },  { date: '16/06', v: 60 },
          { date: '17/06', v: 60 }, { date: '18/06', v: 60 }, { date: '19/06', v: 60 },
          { date: '20/06', v: 60 }, { date: '21/06', v: 60 },
          { date: '23/06', v: 60 }, { date: '24/06', v: 60 }, { date: '25/06', v: 60 },
          { date: '26/06', v: 0 },  { date: '27/06', v: 0 },
        ],
      },
      {
        id: '8', name: 'Alcohol Etilico (Lts)', unit: 'Lts',
        initialStock: 190, ajuste: -70, dailyConsumption: 4, minimum: 40,
        history: [
          { date: '28/05', v: 4 }, { date: '29/05', v: 0 }, { date: '30/05', v: 4 },
          { date: '31/05', v: 0 }, { date: '01/06', v: 4 }, { date: '02/06', v: 0 },
          { date: '03/06', v: 0 }, { date: '04/06', v: 20 },{ date: '05/06', v: 0 },
          { date: '06/06', v: 0 }, { date: '07/06', v: 0 }, { date: '08/06', v: 0 },
          { date: '09/06', v: 0 }, { date: '10/06', v: 8 }, { date: '11/06', v: 0 },
          { date: '12/06', v: 0 }, { date: '13/06', v: 0 }, { date: '14/06', v: 0 },
          { date: '15/06', v: 0 }, { date: '16/06', v: 0 }, { date: '16/06', v: 0 },
          { date: '17/06', v: 0 }, { date: '18/06', v: 0 }, { date: '19/06', v: 0 },
          { date: '20/06', v: 0 }, { date: '21/06', v: 0 },
    ...
    gases: [
      { id: '1', name: 'Propano', full: 5, inUse: 3, available: 1 },
      { id: '2', name: 'Oxigeno', full: 4, inUse: 1, available: 3 },
      { id: '3', name: 'Argon', full: 3, inUse: 1, available: 0 },
    ],
    combustible: {
      initialAmount: 21449,
      log: [
        { date: '01/06/26', consumption: 3000 },
        { date: '02/06/26', consumption: 413 },
        { date: '02/06/26', consumption: 60 },
    ...
    novedades: [
      {
        id: '1',
        equipo: 'Generador del campamento',
        diagnostico: 'No encendia, se reemplazo el modulo eim, queda corregida la falla. El radiador esta totalmente tapado con peluza (se debe lavar externamente). La velocidad del motor no es estable, la bomba de inyeccion requiere servicio. Ruido irregular en el motor (sera necesario desmontar la camara para evaluar).',
        accion: 'El generador va a mantenimiento de bomba de inyeccion, inyectores, camara, camara y bomba de agua a servicio. Hoy fueron llevados todos estos equipos a los tecnicos para su mantenimiento.',
      },
      {
        id: '2',
        equipo: 'Extractor',
        diagnostico: 'Se mando una pieza a PZO para trabajar en el torno y hay que hacerle una base.',
        accion: 'Ya la pieza se mando a PZO y se esta contactando al albanil para el trabajo de la base para el extractor.',
      },
      {
        id: '3',
        equipo: 'Horno azul grande',
        diagnostico: 'Presenta falla en la bobina.',
        accion: 'Ya se puede retirar el horno para ser probado en Tumeremo.',
      },
    ],
  };
}
